...
if __name__ == '__main__':
    ...
    """
    labels_pred = "labels_pred.txt"

    score = evaluation(os.path.join(DATA_DIR, LABELS_TRUE + ".txt"), os.path.join(DATA_DIR, labels_pred))

    print("Score for %s: %s" % (labels_pred, score))
